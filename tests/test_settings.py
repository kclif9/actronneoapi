...
@pytest.fixture
def settings_with_api(mock_api):
...
class TestSettingsAsyncSetSystemMode:
    ...
    @pytest.mark.asyncio
    async def test_set_system_mode_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_system_mode_without_api(self, settings_without_api):
...
class TestSettingsAsyncSetFanMode:
    ...
    @pytest.mark.asyncio
    async def test_set_fan_mode_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_fan_mode_without_api(self, settings_without_api):
...
class TestSettingsAsyncSetContinuousMode:
    ...
    @pytest.mark.asyncio
    async def test_set_continuous_mode_enable_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_continuous_mode_disable_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_continuous_mode_without_api(self, settings_without_api):
...
class TestSettingsAsyncSetTemperature:
    ...
    @pytest.mark.asyncio
    async def test_set_temperature_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_temperature_clamps_to_cool_limits(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_temperature_clamps_to_heat_limits(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_temperature_without_api(self, settings_without_api):
...
class TestSettingsAsyncSetAwayMode:
    ...
    @pytest.mark.asyncio
    async def test_set_away_mode_enable_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_away_mode_disable_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_away_mode_without_api(self, settings_without_api):
...
class TestSettingsAsyncSetQuietMode:
    ...
    @pytest.mark.asyncio
    async def test_set_quiet_mode_enable_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_quiet_mode_disable_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_quiet_mode_without_api(self, settings_without_api):
...
class TestSettingsAsyncSetTurboMode:
    ...
    @pytest.mark.asyncio
    async def test_set_turbo_mode_enable_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_turbo_mode_disable_with_api(self, settings_with_api, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_set_turbo_mode_without_api(self, settings_without_api):
